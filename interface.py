...
def guide():
    messagebox.showinfo(title="Информация", message="Здравствуйте! Для эффективного использования модуля следуйте алгоритму:\n"
                                                 "1. Введите необходимые данные в окно Параметры (выделено черным прямоугольником). Нажмите кнопку Сохранить.\n"
                                                 ...
                                                 "6. Нажмите кнопку Запустить алгоритм. Дождитесь появления всплывающего окна с информацией об \n успешном сохранении коэффициентов.\n"
                                                 ...
                                                 "9. Вычисленные значения появятся справа от окна ввода координат.\n"
...
def equation_info():
    messagebox.showinfo(title="Информация", message="Программный модуль поддерживает следующие функции:\n"
                                                    "1. Синус - вводить как sin(x)\n"
                                                    "2. Косинус - вводить как cos(x)\n"
                                                    "3. Тангенс - вводить как tan(x) или tg(x)\n"
                                                    "4. Число Пи - вводить как pi \n"
                                                    "5. Знак деления - /, возведения в степень - ** или ^\n"
                                                    "При необходимости расширения функций свяжитесь с разработчиком.")

def programm_info():
    messagebox.showinfo(title="Информация", message="Программный модуль разработан Гайнутдиновой Лианой.\n"
                                                    "Контакты:\n"
                                                    "Почта: losrtich13@gmail.com\n"
...
helpmenu.add_command(label="Ввод уравнений", font=("", 14), command=equation_info)
helpmenu.add_command(label="О программе", command=programm_info, font=("", 14))
